...
## fscio.system::cfgproducer    account config
...
## fscio.system::okproducer     account producer vote
...
## fscio.system::unstake        account quantity 
...
## fscio.system::withdraw account
   - this action can only be triggered by fscio.system via a deferred transaction generated by unstake
   - this will generate an inline fscio.token::transfer call from=fscio.system to=account and amount equal to the next withdraw increment
   - this will generate another deferred withdraw to continue the process if there are still withdraws to be made


## fscio.system::transfer from to amount memo
   - decrements balance of from if amount <= balance
   - increments balance of to by amount
   - memo is ignored 

## fscio.system::stakevote account amount
   - the primary currency of fscio is controlled by the token contract which enables users to transfer
...
## fscio.system::onblock   account blocktime blocknum
...
## fscio.system::freeze producer accounts true|false 
...
## fscio.system::paystandby producer
